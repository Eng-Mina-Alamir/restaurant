...
-- ------------------------------------------------------------------------------
-- The live schema has diverged from this baseline (RLS hardening, InitPlan
-- policy rewrite, new tables chat_messages/order_status_log, integrity
-- constraints). Do NOT run this file against any environment.
-- Source of truth: supabase/migrations/* + 'supabase db pull'.
-- See DEPLOYMENT.md section 3b.
-- ==============================================================================
-- ==============================================================================
...
-- ============================================================================
-- ARCHIVED: cloud cart tables (cart_items / cart_item_modifiers)
-- ----------------------------------------------------------------------------
-- Mirrors supabase/migrations/20260824195960_create_cart_tables.sql exactly.
-- The migrations directory remains the source of truth (DEPLOYMENT.md §3b);
-- this copy exists so the archived snapshot can stand alone.
-- ============================================================================
