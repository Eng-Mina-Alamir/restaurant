...
void main() {
  group('Timeline 6: Delivery Driver Operations Journey Test', () {
    ...
    test(
      'Driver Timeline: View Assigned Orders -> Pickup from Kitchen -> In-Transit GPS -> Photo Proof -> Complete Delivery',
      () async {
        ...
        const proofOfDeliveryMockUrl =
            'https://restaurant.app/storage/proof/pod_505.jpg';
