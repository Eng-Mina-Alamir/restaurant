...
void main() {
  group('Timeline 7: Manager & Operations Full Journey Test', () {
    ...
    test(
      'Manager Operations Timeline: Live KPIs -> Update Menu -> Low Stock Audit -> Create Promo -> Export Financial Reports (CSV)',
      () async {
        ...
        final grossRevenue = dailyOrders.fold<double>(
          0,
        ...
        expect(
          weekendPromo.calculateDiscount(100.0),
          equals(0.0),
        ); // under min spend
        ...
        final inventoryCsv = exportService.generateInventoryCsv([
          beefInventory,
          restockedBeef,
        ]);
        ...
        final financeCsv = exportService.generateFinancialReportCsv(
          financialMetrics,
          'اليومي',
        );
