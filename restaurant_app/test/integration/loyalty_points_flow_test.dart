...
void main() {
  group('Loyalty Points Flow Integration Test', () {
    test(
      'customer earns points from orders, advances tiers, and redeems rewards',
      () async {
        ...
        expect(
          finalAccount.currentPoints,
          updatedAccount.currentPoints - reward.pointsCost,
        );
        expect(
          finalAccount.transactions.any(
            (t) => t.type == PointsTransactionType.redeem,
          ),
          isTrue,
        );
      },
