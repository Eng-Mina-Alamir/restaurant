...
void main() {
  test('Reservation & Table Lifecycle Integration Flow', () async {
    ...
    final resController = container.read(
    ...
    final myRes = reservations.firstWhere(
      (r) => r.customerName == 'عبدالله السبيعي',
    );
    ...
    final availableTable = container
        .read(tableControllerProvider)
        .firstWhere((t) => t.id == targetTable.id);
