...
void main() {
  ...
  group('InvoicesPage', () {
    testWidgets('shows empty state when no completed orders exist', (tester) async {
    ...
    testWidgets('shows invoice card when completed orders exist and clicking export triggers snackbar', (tester) async {
      ...
      expect(container.read(ordersControllerProvider).first.status, OrderStatus.completed);
