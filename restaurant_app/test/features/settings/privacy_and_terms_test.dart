...
void main() {
  group('Privacy Policy and Terms Pages', () {
    testWidgets('PrivacyPolicyPage renders security and data usage sections', (tester) async {
    ...
    testWidgets('TermsPage renders cancellation, pricing, and delivery conditions', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: TermsPage(),
        ),
      ...
      await tester.scrollUntilVisible(find.text('4. التوصيل والمسؤولية'), 200);
