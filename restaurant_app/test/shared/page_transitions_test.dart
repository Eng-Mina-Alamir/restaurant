...
void main() {
  group('AppPageTransitions Tests', () {
    testWidgets('fadeSlide creates CustomTransitionPage and builds transitions',
        (tester) async {
    ...
    testWidgets('scaleFade creates CustomTransitionPage and builds transitions',
        (tester) async {
    ...
    testWidgets('sharedAxis creates CustomTransitionPage and builds transitions',
        (tester) async {
