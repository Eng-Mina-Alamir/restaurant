...
void main() {
  group('Suite 5: Delivery Driver Flow (تجربة مندوب التوصيل)', () {
    ...
    // -------------------------------------------------------------
    test(
      'TC-DRV-01: Driver receives delivery assignment details with address, phone, and total amount',
      () async {
    ...
    // -------------------------------------------------------------
    test(
      'TC-DRV-02: Driver accepts assignment and starts delivery transit',
      () async {
    ...
    test('TC-DRV-03: Driver updates live GPS coordinates during transit', () {
      ...
      expect(
        () => deliveryNotifier.updateLocation(
          latitude: 30.050,
          longitude: 31.240,
        ),
        returnsNormally,
    ...
    // -------------------------------------------------------------
    test(
      'TC-DRV-04: Driver confirms delivery and timestamps completion',
      () async {
        final container = createQaContainer();
        addTearDown(container.dispose);
